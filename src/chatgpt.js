...
const getMessage = (m) => `
 ...
 Необходимо в итоге получить такую историю, чтоб я запомнил этот день и смог в последствии рассказать ее друзьям. Текст не должен быть больше 100 слов. Главное, чтобы были эмоции, правильная последовательность + учтение контекста.
`;
...
export async function chatGPT(message = '') {
	...
	try {
		...
		console.error('Error while chat competion', e.message);
	}
}
